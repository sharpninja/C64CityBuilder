# Program activity/state documentation
...
## Rendered combined diagram
![Program diagram](program.activity.svg)

## Combined summary
- Total states: `580`
- Synthetic entry points: `0`
- Total branch/jump/jsr transitions: `915`
- Total terminal states: `144`

## Assembler file descriptions

### `buildings.s`
- States: `71`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `92`
- Terminal states: `24`
- Entry label: `try_place_building`
- Exit label: `@sbn_done`
- Documentation: [`buildings.activity.md`](buildings.activity.md)

### `constants.s`
- States: `0`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `0`
- Terminal states: `0`
- Entry label: `N/A`
- Exit label: `N/A`
- Documentation: [`constants.activity.md`](constants.activity.md)
...
- Branch/jump/jsr transitions: `0`
- Terminal states: `0`
- Entry label: `mul40_lo`
- Exit label: `hud_level_names`
- Documentation: [`data.activity.md`](data.activity.md)

### `init.s`
- States: `25`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `24`
- Terminal states: `9`
- Entry label: `init_system`
- Exit label: `@river`
- Documentation: [`init.activity.md`](init.activity.md)

### `input.s`
- States: `43`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `71`
- Terminal states: `7`
- Entry label: `read_input`
- Exit label: `@ri_done`
- Documentation: [`input.activity.md`](input.activity.md)

### `main.s`
- States: `6`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `16`
- Terminal states: `0`
- Entry label: `game_start`
- Exit label: `@no_ui_redraw`
- Documentation: [`main.activity.md`](main.activity.md)

### `map.s`
- States: `54`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `77`
- Terminal states: `22`
- Entry label: `render_map`
- Exit label: `@rcc_no_carry`
- Documentation: [`map.activity.md`](map.activity.md)

### `simulation.s`
- States: `289`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `505`
- Terminal states: `61`
- Entry label: `mul_by_5`
- Exit label: `@no_year`
- Documentation: [`simulation.activity.md`](simulation.activity.md)

### `title.s`
- States: `7`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `22`
- Terminal states: `2`
- Entry label: `show_title`
- Exit label: `@src_loop`
- Documentation: [`title.activity.md`](title.activity.md)

### `ui.s`
- States: `61`
- Synthetic states: `0`
- Branch/jump/jsr transitions: `108`
- Terminal states: `19`
- Entry label: `print_str_col`
- Exit label: `@hsel_done`
- Documentation: [`ui.activity.md`](ui.activity.md)
...
- Entry label: `N/A`
- Exit label: `N/A`
- Documentation: [`zeropage.activity.md`](zeropage.activity.md)
